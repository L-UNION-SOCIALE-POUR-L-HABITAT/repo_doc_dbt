    ...
    EXEC('create view "dbo"."dim_patrimoine_sortie__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_gold"."dbo"."dim_patrimoine_sortie__dbt_temp" AS SELECT * FROM "wh_dp_gold"."dbo"."dim_patrimoine_sortie__dbt_temp__dbt_tmp_vw" 
