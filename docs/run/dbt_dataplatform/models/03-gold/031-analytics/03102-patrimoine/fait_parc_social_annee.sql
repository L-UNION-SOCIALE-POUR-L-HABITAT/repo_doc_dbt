    ...
    EXEC('create view "dbo"."fait_parc_social_annee__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_gold"."dbo"."fait_parc_social_annee__dbt_temp" AS SELECT * FROM "wh_dp_gold"."dbo"."fait_parc_social_annee__dbt_temp__dbt_tmp_vw" 
