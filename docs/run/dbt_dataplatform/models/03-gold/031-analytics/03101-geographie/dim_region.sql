    ...
    EXEC('create view "dbo"."dim_region__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_gold"."dbo"."dim_region__dbt_temp" AS SELECT * FROM "wh_dp_gold"."dbo"."dim_region__dbt_temp__dbt_tmp_vw" 
