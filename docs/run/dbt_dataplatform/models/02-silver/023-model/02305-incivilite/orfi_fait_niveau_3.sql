    ...
    EXEC('create view "dbi"."orfi_fait_niveau_3__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."dbi"."orfi_fait_niveau_3__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbi"."orfi_fait_niveau_3__dbt_temp__dbt_tmp_vw" 
