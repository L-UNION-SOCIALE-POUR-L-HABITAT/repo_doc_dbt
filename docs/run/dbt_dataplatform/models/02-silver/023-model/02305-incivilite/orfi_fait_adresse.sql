    ...
    EXEC('create view "dbo"."orfi_fait_adresse__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."dbo"."orfi_fait_adresse__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."orfi_fait_adresse__dbt_temp__dbt_tmp_vw" 
