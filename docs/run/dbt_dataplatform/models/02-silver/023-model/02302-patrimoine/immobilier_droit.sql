    ...
    EXEC('create view "dbo"."immobilier_droit__dbt_temp__dbt_tmp_vw" as /**
 *
...
;');
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."immobilier_droit__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."immobilier_droit__dbt_temp__dbt_tmp_vw" 
