    ...
    EXEC('create view "dbo"."ref_categorie_logement__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."ref_categorie_logement__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."ref_categorie_logement__dbt_temp__dbt_tmp_vw" 
