    ...
    EXEC('create view "dbo"."demandeur_type__dbt_temp__dbt_tmp_vw" as 
...
;');
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."demandeur_type__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."demandeur_type__dbt_temp__dbt_tmp_vw" 
