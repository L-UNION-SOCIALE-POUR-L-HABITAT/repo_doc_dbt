    ...
    EXEC('create view "dbo"."demandeur_age_tranche__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."demandeur_age_tranche__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."demandeur_age_tranche__dbt_temp__dbt_tmp_vw" 
