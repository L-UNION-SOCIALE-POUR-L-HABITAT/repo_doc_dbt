    ...
    EXEC('create view "dbo"."demande_mode_logement_actuel__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."demande_mode_logement_actuel__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."demande_mode_logement_actuel__dbt_temp__dbt_tmp_vw" 
