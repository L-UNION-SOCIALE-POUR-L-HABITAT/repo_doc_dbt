    ...
    EXEC('create view "dbo"."passage_commune_histo__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."passage_commune_histo__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."passage_commune_histo__dbt_temp__dbt_tmp_vw" 
