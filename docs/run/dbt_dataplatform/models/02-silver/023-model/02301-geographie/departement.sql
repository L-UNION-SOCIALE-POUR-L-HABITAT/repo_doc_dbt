    ...
    EXEC('create view "dbo"."departement__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."dbo"."departement__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."departement__dbt_temp__dbt_tmp_vw" 
