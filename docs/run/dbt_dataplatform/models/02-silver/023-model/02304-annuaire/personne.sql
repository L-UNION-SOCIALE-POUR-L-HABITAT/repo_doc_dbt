    ...
    EXEC('create view "dbo"."personne__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."dbo"."personne__dbt_temp" AS SELECT * FROM "wh_dp_silver"."dbo"."personne__dbt_temp__dbt_tmp_vw" 
