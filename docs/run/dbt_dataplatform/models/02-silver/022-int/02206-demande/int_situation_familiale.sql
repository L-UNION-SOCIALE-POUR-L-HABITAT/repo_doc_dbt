    ...
    EXEC('create view "int"."int_situation_familiale__dbt_temp__dbt_tmp_vw" as 
...
;');
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."int"."int_situation_familiale__dbt_temp" AS SELECT * FROM "wh_dp_silver"."int"."int_situation_familiale__dbt_temp__dbt_tmp_vw" 
