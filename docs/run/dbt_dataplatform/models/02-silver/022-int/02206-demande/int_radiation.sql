    ...
    EXEC('create view "int"."int_radiation__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."int"."int_radiation__dbt_temp" AS SELECT * FROM "wh_dp_silver"."int"."int_radiation__dbt_temp__dbt_tmp_vw" 
