    ...
    EXEC('create view "int"."int_orfi_groupe__dbt_temp__dbt_tmp_vw" as /**
 *
...
(
    ...
    where organisme_code_union is not NULL
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."int"."int_orfi_groupe__dbt_temp" AS SELECT * FROM "wh_dp_silver"."int"."int_orfi_groupe__dbt_temp__dbt_tmp_vw" 
