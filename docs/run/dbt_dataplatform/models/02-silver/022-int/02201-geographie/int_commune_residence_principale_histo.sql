    ...
    EXEC('create view "int"."int_commune_residence_principale_histo__dbt_temp__dbt_tmp_vw" as -- -----------------------------------------------------------------------------
-- Description :
...
from cte_finale;');
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."int"."int_commune_residence_principale_histo__dbt_temp" AS SELECT * FROM "wh_dp_silver"."int"."int_commune_residence_principale_histo__dbt_temp__dbt_tmp_vw" 
