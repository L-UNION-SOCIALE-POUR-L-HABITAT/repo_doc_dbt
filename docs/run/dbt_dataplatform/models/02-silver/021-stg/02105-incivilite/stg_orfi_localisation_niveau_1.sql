    ...
    EXEC('create view "stg"."stg_orfi_localisation_niveau_1__dbt_temp__dbt_tmp_vw" as /**
 *
...
-------------------------------------------------------------------
 ...
 (
    select 
        [id]                    as orfi_localisation_niveau_1_id,
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_orfi_localisation_niveau_1__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_orfi_localisation_niveau_1__dbt_temp__dbt_tmp_vw" 
