    ...
    EXEC('create view "stg"."stg_orfi_processus__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    cte_finale;');
            ...
            EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_orfi_processus__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_orfi_processus__dbt_temp__dbt_tmp_vw" 
