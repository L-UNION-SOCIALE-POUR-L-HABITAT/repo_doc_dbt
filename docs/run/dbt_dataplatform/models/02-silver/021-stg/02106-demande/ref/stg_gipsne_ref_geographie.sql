    ...
    EXEC('create view "stg"."stg_gipsne_ref_geographie__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_gipsne_ref_geographie__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_gipsne_ref_geographie__dbt_temp__dbt_tmp_vw" 
