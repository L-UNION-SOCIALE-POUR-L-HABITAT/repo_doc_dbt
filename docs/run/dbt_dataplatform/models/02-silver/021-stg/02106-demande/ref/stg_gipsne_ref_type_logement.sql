    ...
    EXEC('create view "stg"."stg_gipsne_ref_type_logement__dbt_temp__dbt_tmp_vw" as 
...
;');
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_gipsne_ref_type_logement__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_gipsne_ref_type_logement__dbt_temp__dbt_tmp_vw" 
