...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_gipsne_ref_categ_logement_rech__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_gipsne_ref_categ_logement_rech__dbt_temp__dbt_tmp_vw" 
