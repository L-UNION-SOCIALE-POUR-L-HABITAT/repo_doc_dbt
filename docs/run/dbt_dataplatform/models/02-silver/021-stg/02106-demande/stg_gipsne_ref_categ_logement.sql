 ...
 *
 * Description :    Alimentation de la table stg_gipsne_ref_categ_logement
 * Fréquence :      Annuel
 * Mode :           Annule et remplace
 * Source:          raw_gipsne_ref_categ_logement
 * Cible :          stg_gipsne_ref_categ_logement
 */
...
-------------------------------------------------------------------
with cte_rename_raw_gipsne_ref_categ_logement as
(
    select 
        --[CLE_CATEG_LOGEMENT],
...
-------------------------------------------------------------------
cte_clean_and_type_raw_gipsne_ref_categ_logement as 
 (
    select
  ...
  as categorie_logement_ordre_affichage,
    ...
    from  cte_rename_raw_gipsne_ref_categ_logement
 ),
...
(
 ...
 as _meta_loaded_at
    ...
    from cte_clean_and_type_raw_gipsne_ref_categ_logement
)
