    ...
    EXEC('create view "stg"."stg_insee_commune_residence_principale_histo__dbt_temp__dbt_tmp_vw" as /**
 *
...
from 
    ...
    EXEC('CREATE TABLE "wh_dp_silver"."stg"."stg_insee_commune_residence_principale_histo__dbt_temp" AS SELECT * FROM "wh_dp_silver"."stg"."stg_insee_commune_residence_principale_histo__dbt_temp__dbt_tmp_vw" 
